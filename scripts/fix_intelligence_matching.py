...
def extract_all_intelligence_properly():
    """Tüm sınıflar için zeka türlerini doğru şekilde çıkar"""
    students = []
    current_student = None
    
    print("=== TÜM SINIFLAR İÇİN ZEKA TÜRLERİ ÇIKARILIYOR ===")
...
# Zeka türlerini çıkar
all_students_with_intelligence = extract_all_intelligence_properly()
...
# Sonuçları kaydet
with open('fixed_intelligence_data.json', 'w', encoding='utf-8') as f:
    json.dump(all_students_with_intelligence, f, ensure_ascii=False, indent=2)

print(f'\n✅ Veriler fixed_intelligence_data.json dosyasına kaydedildi!')
